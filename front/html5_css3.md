...
* 15. [CSS高级技巧导读](#CSS)
	...
	* 15.2. [字体图标](#-1)
		...
		* 15.2.2. [字体图标追加](#-1)
	* 15.3. [CSS三角](#CSS-1)
	* 15.4. [CSS用户界面样式](#CSS-1)
		* 15.4.1. [鼠标样式cursor](#cursor)
...
```
###  15.4. <a name='CSS-1'></a>CSS用户界面样式
所谓**界面样式**，就是更改一些用户操作样式，以便提高用户体验
####  15.4.1. <a name='cursor'></a>鼠标样式cursor
| 属性        | 描述      |
| ----------- | --------- |
| default     | 小白 默认 |
| move        | 移动      |
...
| pointer     | 小手      |
| text        | 文本      |
####  15.4.2. <a name='outline'></a>轮廓线outline
给表单、文本域添加outline:0;或者outline:none样式之后,就可以去掉默认的蓝色边框
####  15.4.3. <a name='-1'></a>防止文本域拖拽
```css
